...
bool ThunderWorker::Disconnect(const tagMsgShell& stMsgShell, bool bMsgShellNotice)
{
...
bool ThunderWorker::AddMsgShell(const std::string& strIdentify, const tagMsgShell& stMsgShell)
{
...
void ThunderWorker::DelMsgShell(const std::string& strIdentify,const tagMsgShell& stMsgShell)
{
    std::map<std::string, tagMsgShell>::iterator shell_iter = m_mapMsgShell.find(strIdentify);
    if (shell_iter == m_mapMsgShell.end())
    {
...
bool ThunderWorker::SendTo(const tagMsgShell& stMsgShell)
{
...
bool ThunderWorker::SendToClient(const tagMsgShell& stMsgShell,MsgHead& oMsgHead,const google::protobuf::Message &message,
...
bool ThunderWorker::SendTo(const tagMsgShell& stMsgShell, const MsgHead& oMsgHead, const MsgBody& oMsgBody)
{
...
bool ThunderWorker::SendTo(const tagMsgShell& stMsgShell, const HttpMsg& oHttpMsg, HttpStep* pHttpStep)
{
...
bool ThunderWorker::SetConnectIdentify(const tagMsgShell& stMsgShell, const std::string& strIdentify)
{
    LOG4_TRACE("%s()", __FUNCTION__);
...
void ThunderWorker::AddInnerFd(const tagMsgShell& stMsgShell)
{
...
bool ThunderWorker::GetMsgShell(const std::string& strIdentify, tagMsgShell& stMsgShell)
{
    LOG4_TRACE("%s(identify: %s)", __FUNCTION__, strIdentify.c_str());
    std::map<std::string, tagMsgShell>::iterator shell_iter = m_mapMsgShell.find(strIdentify);
    if (shell_iter == m_mapMsgShell.end())
...
bool ThunderWorker::SetClientData(const tagMsgShell& stMsgShell, thunder::CBuffer* pBuff)
{
    LOG4_TRACE("%s()", __FUNCTION__);
    std::map<int, tagConnectionAttr*>::iterator iter = m_mapFdAttr.find(stMsgShell.iFd);
    if (iter == m_mapFdAttr.end())
...
bool ThunderWorker::HadClientData(const tagMsgShell& stMsgShell)
{
    std::map<int, tagConnectionAttr*>::iterator conn_iter;
...
bool ThunderWorker::GetClientData(const tagMsgShell& stMsgShell, thunder::CBuffer* pBuff)
{
	LOG4_TRACE("%s()", __FUNCTION__);
	std::map<int, tagConnectionAttr*>::iterator iter = m_mapFdAttr.find(stMsgShell.iFd);
	if (iter == m_mapFdAttr.end())
...
std::string ThunderWorker::GetClientAddr(const tagMsgShell& stMsgShell)
{
    LOG4_TRACE("%s()", __FUNCTION__);
    std::map<int, tagConnectionAttr*>::iterator iter = m_mapFdAttr.find(stMsgShell.iFd);
    if (iter == m_mapFdAttr.end())
...
std::string ThunderWorker::GetConnectIdentify(const tagMsgShell& stMsgShell)
{
    LOG4_TRACE("%s()", __FUNCTION__);
    std::map<int, tagConnectionAttr*>::iterator iter = m_mapFdAttr.find(stMsgShell.iFd);
    if (iter == m_mapFdAttr.end())
...
void ThunderWorker::MsgShellNotice(const tagMsgShell& stMsgShell, const std::string& strIdentify, thunder::CBuffer* pClientData)
{
    LOG4_TRACE("%s()", __FUNCTION__);
...
bool ThunderWorker::Dispose(const tagMsgShell& stMsgShell,
