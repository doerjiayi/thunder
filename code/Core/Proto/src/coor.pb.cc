...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "coor.proto", schemas, file_default_instances, TableStruct::offsets,
...
Election::Election()
  ...
  ::google::protobuf::internal::InitSCC(
      &protobuf_coor_2eproto::scc_info_Election.base);
  SharedCtor();
...
const ::google::protobuf::Descriptor* Election::descriptor() {
  ::protobuf_coor_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_coor_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}

const Election& Election::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_coor_2eproto::scc_info_Election.base);
...
::google::protobuf::Metadata Election::GetMetadata() const {
  protobuf_coor_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_coor_2eproto::file_level_metadata[kIndexInFileMessages];
}
