...
CTlv::CTlv()
    : CStreamCodec(CODEC_TLV), m_uiType(0), m_uiLength(0)
{
}

CTlv::CTlv(unsigned int uiType, unsigned int uiLength, const util::CBuffer& oBuff)
    : CStreamCodec(CODEC_TLV), m_uiType(uiType), m_uiLength(uiLength)
{
...
bool CTlv::Encode(unsigned int uiType, unsigned int uiInBuffLength, const util::CBuffer& oInBuff, util::CBuffer& oOutBuff)
{
...
bool CTlv::Encode(util::CBuffer& oOutBuff)
{
    unsigned int uiWriteLength = 0;
...
bool CTlv::Decode(util::CBuffer& oInBuff)
{
